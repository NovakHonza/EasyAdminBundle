...
namespace EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp\Tests;

use EasyCorp\Bundle\EasyAdminBundle\Config\Action;
use EasyCorp\Bundle\EasyAdminBundle\Config\Option\EA;
use EasyCorp\Bundle\EasyAdminBundle\Router\AdminUrlGenerator;
use EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp\Controller\BlogPostCrudController;
use EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp\Controller\CategoryCrudController;
use EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp\Controller\DashboardController;
use EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp\Controller\SecondDashboardController;
use EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp\Entity\Category;
use EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp\Tests\Factory\BlogPostFactory;
use EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp\Tests\Factory\CategoryFactory;
use EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp\Tests\Factory\UserFactory;
use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;
use Symfony\Component\Routing\Router;
use Zenstruck\Foundry\Test\Factories;
use Zenstruck\Foundry\Test\ResetDatabase;

class PrettyUrlsTest extends WebTestCase
{
    use Factories;
    use ResetDatabase;
    ...
    public function testGeneratedRoutes()
    {
        ...
        $expectedRoutes['admin_pretty_category_custom_action'] = '/admin/pretty/urls/category/custom/action';
    ...
    {
        CategoryFactory::createOne(['id' => 1]);
    ...
    {
        BlogPostFactory::createOne(['id' => 1]);
        ...
        $this->assertMatchesRegularExpression('#http://localhost/admin/pretty/urls/blog-post/1/edit\?csrfToken=.*&fieldName=published#', $crawler->filter('td.field-boolean input[type="checkbox"]')->attr('data-toggle-url'));
    }
    ...
    public function testDefaultSortLinksUsePrettyUrls()
    {
        ...
        $this->assertSame('http://localhost/admin/pretty/urls/blog-post?page=1&sort%5Bpublished%5D=DESC', $crawler->filter('th.searchable a')->eq(1)->attr('href'));
    }
    ...
    public function testAdminUrlGenerator(): void
    {
        ...
        $client->request('GET', '/admin/pretty/urls/category/custom/action');

        $this->assertSelectorTextSame('#url1', 'http://localhost/admin/pretty/urls/category/custom/action');
        $this->assertSelectorTextSame('#url2', 'http://localhost/admin/pretty/urls/category/custom/action?page=2');
        $this->assertSelectorTextSame('#url3', 'http://localhost/admin/pretty/urls/category/new');
        $this->assertSelectorTextSame('#url4', 'http://localhost/admin/pretty/urls/blog-post');
        $this->assertSelectorTextSame('#url5', 'http://localhost/second/dashboard');
        $this->assertSelectorTextSame('#url6', 'http://localhost/second/dashboard/user-editor/custom/path-for-detail/3');
    }

    /**
     * @dataProvider provideUglyUrlRedirects
     */
    public function testUglyUrlsAreNoLongerRedirectedToPrettyUrls(string $crudControllerFqcn, string $crudAction, ?int $entityId, array $extraQueryParameters, string $expectedPrettyUrlRedirect)
    {
        $client = static::createClient();
        ...
        $this->assertSelectorTextContains('h1', 'Welcome to EasyAdmin 5', 'Ugly URLs are no longer redirected to the corresponding pretty URL. The query string parameters for CRUD controller, action, etc. are ignored, so the /admin/pretty/urls page is rendered.');
    }
    ...
    public function testPrettyAdminUrlCreatedWithAdminDashboardAttribute(): void
    {
        ...
        $this->assertSame([
            ...
            '_format' => 'html',
            '_stateless' => true,
            '_controller' => 'EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp\Controller\ThirdDashboardController::index',
            'routeCreatedByEasyAdmin' => true,
            'dashboardControllerFqcn' => 'EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp\Controller\ThirdDashboardController',
