...
namespace EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\PrettyUrlsApp;
...
final class Kernel extends SymfonyKernel
{
    ...
    {
        return $this->getProjectDir().'/var/cache/tests/PrettyUrlsApp';
    }

    public function getLogDir(): string
    {
        return $this->getProjectDir().'/var/log/tests/PrettyUrlsApp';
    }
    ...
    protected function configureContainer(ContainerConfigurator $container, LoaderInterface $loader): void
    {
        ...
        ;
        $services
            ->load('EasyCorp\\Bundle\\EasyAdminBundle\\Tests\\Functional\\PrettyUrlsApp\\', __DIR__.'/*')
            ->exclude('{Entity,Tests,Kernel.php}');
        $services
            ->load('EasyCorp\\Bundle\\EasyAdminBundle\\Tests\\Functional\\PrettyUrlsApp\\Controller\\', __DIR__.'/Controller/')
            ...
            'orm' => [
                ...
                'mappings' => [
                    'TestEntities' => [
                        ...
                        'prefix' => 'EasyCorp\\Bundle\\EasyAdminBundle\\Tests\\Functional\\PrettyUrlsApp\\Entity',
                        'alias' => 'app',
                    ],
                ],
            ],
