...
/**
 * Dashboard controller for testing Dashboard::disableDarkMode().
 */
#[AdminDashboard(routePath: '/customization_darkmode_admin', routeName: 'customization_darkmode_admin')]
class DarkModeTestDashboardController extends AbstractDashboardController
{
