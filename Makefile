...
## —— Tests ———————————————————————————————————
tests: ## Run tests
	php vendor/bin/simple-phpunit --configuration tests/Functional/PrettyUrlsApp/phpunit.xml.dist
	php vendor/bin/simple-phpunit --configuration tests/Functional/SecureApp/phpunit.xml.dist
	SYMFONY_DEPRECATIONS_HELPER=weak php vendor/bin/simple-phpunit
